...
As the server is hosted on a free service, it may take around 30 seconds to start up upon the first visit.<br>
...
Fonctionnalités : API de blagues créée intégralement pour une distribution de contenu aléatoire, Fetch API pour la récupération asynchrone des données, design UX/UI épuré pour une expérience fun et immédiate.<br>
